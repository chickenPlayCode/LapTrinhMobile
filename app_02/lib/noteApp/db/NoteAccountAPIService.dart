...
class NoteAccountAPIService {
  ...
  Future<NoteAccount> createAccount(NoteAccount account) async {
    ...
    if (response.statusCode == 201) {
      ...
      throw Exception('Không thể tạo tài khoản: ${response.statusCode}');
    }
  }
  ...
  Future<List<NoteAccount>> getAllAccounts() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Không thể tải danh sách tài khoản: ${response.statusCode}');
    }
  }
  ...
  Future<NoteAccount?> getAccountById(int id) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Không thể lấy tài khoản: ${response.statusCode}');
    }
  }
  ...
  Future<NoteAccount> updateAccount(NoteAccount account) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Không thể cập nhật tài khoản: ${response.statusCode}');
    }
  }
  ...
  Future<bool> deleteAccount(int id) async {
    ...
    if (response.statusCode == 200 || response.statusCode == 204) {
      ...
      throw Exception('Không thể xóa tài khoản: ${response.statusCode}');
    }
  }
